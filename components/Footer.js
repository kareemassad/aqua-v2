        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          <div>
            ...
            <p className="mt-4 text-base text-gray-300">
              {config.appName} provides you with the boilerplate code you need to launch your startup fast.
            </p>
          </div>
          <div>
            ...
            <ul className="mt-4 space-y-4">
              {config.mailgun.supportEmail && (
                <li>
                  <a href={`mailto:${config.mailgun.supportEmail}`} className="text-base text-gray-300 hover:text-white">
                    Support
                  </a>
                </li>
              )}
