...
export async function PUT(request, { params }) {
    ...
    try {
      ...
      if (contact_info) {
        store.contact_info.phone = contact_info.phone ? validator.escape(contact_info.phone) : store.contact_info.phone;
        store.contact_info.email = contact_info.email && validator.isEmail(contact_info.email)
